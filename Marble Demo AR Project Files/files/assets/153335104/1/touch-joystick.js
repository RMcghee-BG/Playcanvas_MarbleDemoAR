...
TouchJoystick.prototype.update = function(dt)
{
    if (this.app.xr.input) {
        if (this.currentInputSource && this.currentEvent)
        {
            this._onXRInputSelectMove(this.currentInputSource, this.currentEvent);
        }
    }
}
...
// XR Input
// ====================================================================================================
TouchJoystick.prototype._onXRInputSelectStart = function (input, e) {
    if (this._pointerDown) {
        return;
    }
...
TouchJoystick.prototype._onXRInputSelectMove = function (input, e) {
    e.type = "selectmove";
...
TouchJoystick.prototype._onXRInputSelectEnd = function (input, e) {
    if (this._pointerDown) {
        var inputPos = this._getEvent(input);
        e.x = inputPos.x;
        e.y = inputPos.y;
...
TouchJoystick.prototype._getEvent = function(inputSource) {
...
TouchJoystick.prototype._getLimits = function() {
    const canvasWidth = this.app.graphicsDevice.canvas.clientWidth;
    const canvasHeight = this.app.graphicsDevice.canvas.clientHeight;
